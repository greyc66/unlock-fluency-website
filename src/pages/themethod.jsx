...
export default function TheMethod() {
  ...
  { title: "Psycholinguistic Foundation", description: "As it follows the natural stages of language acquisition, the Method can be adapted for different age groups. So far, it has proven to be effective with learners of all ages — from young adults to mature learners.", icon: BrainCircuit },
  ...
  { title: "Refining the Method", description: "Synthesising a decade of research and teaching experience into a unique teaching philosophy has taught me to constantly evolve, always seeking to refine my courses and incorporate student feedback.", icon: PenSquare }];
