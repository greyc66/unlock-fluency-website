...
const individualCoursesList = [
    { level: 'intermediate', levelCode: 'B1/B2', title: "Unlock Fluency Signature", description: "An intensive, intermediate-to-advanced fluency sprint to boost your fluency. This course is designed to build confidence in speaking spontaneously and expressing opinions clearly. Focuses on essential vocabulary, daily conversations, and real-life scenarios through guided discussions, role plays, and mini-debates. Includes a personalised 45-minute video consultation with Dr Grey at the end of the course.", length: "5 consecutive days", duration: "6 hours daily", participants: "6-16", format: "Online", price: "£260" },
    { level: 'intermediate', levelCode: 'B1/B2', title: "Maintain Fluency", description: "A week-long evening course designed to strengthen fluency for real-life scenarios. Works well as a confidence booster, or to maintain fluency after the Unlock Fluency Signature course.", length: "5 consecutive days", duration: "3 hours daily", participants: "6-16", format: "Online", price: "£180" },
    ...
    { level: 'mixed-levels', title: "Series Club", description: "Let's watch a popular English series together! This course is designed to improve listening comprehension, everyday expressions, and natural conversation skills.", length: "8 consecutive weeks", duration: "1 x 3-hour session weekly", participants: "6-16", format: "Online", price: "£220" },
];
