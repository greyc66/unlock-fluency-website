...
const individualCoursesList = [
    { level: 'intermediate', levelCode: 'B1/B2', title: "Unlock Fluency Signature", description: "An intensive, intermediate-to-advanced fluency sprint to boost your fluency. This course is designed to build confidence in speaking spontaneously and expressing opinions clearly. Focuses on essential vocabulary, daily conversations, and real-life scenarios through guided discussions, role plays, and mini-debates. Includes a personalised 45-minute video consultation with Dr Grey at the end of the course.", length: "5 consecutive days", duration: "6 hours daily", participants: "6-12", format: "Online", price: "£260" },
    { level: 'intermediate', levelCode: 'B1/B2', title: "Maintain Fluency", description: "A week-long evening course designed to strengthen fluency for real-life scenarios. Works well as a confidence booster, or to maintain fluency after the Unlock Fluency Signature course.", length: "5 consecutive days", duration: "3 hours daily", participants: "6-12", format: "Online", price: "£180" },
    { level: 'intermediate', levelCode: 'B1/B2', title: "Weekend Boost", description: "A weekend immersion course designed to build consistent, practical fluency for everyday use. Works well as a refresher course and is the recommended next step after the Unlock Fluency Signature course.", footnote: "Get in touch with me if you only want to attend a single weekend.", length: "4 consecutive weekends", duration: "3 hours daily", participants: "6-12", format: "Online", price: "£220" },
