...
export default function Resources() {
  const resourceSections = [
    ...
    {
      title: "English Tradition of the Month",
      icon: Coffee,
      description: "Explore the quirky customs and traditions that make British culture unique. Perfect conversation starters!",
      items: [
        "Monthly deep-dives into British customs",
        "Cultural context and historical background",
        "How to discuss traditions naturally in conversation"
      ],
      bgColor: "bg-orange-200"
    },
    {
      title: "TED Talk of the Week",
      icon: Globe, // Changed from Video to Globe
    ...
    },
    {
      ...
      icon: Users, // Changed from Globe to Users
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {resourceSections.map((section, index) => (
              <Card key={index} className={`${section.bgColor} border-gray-400 hover:border-gray-600 transition-all duration-300`}>
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-gray-800 mb-6">{section.description}</p>
